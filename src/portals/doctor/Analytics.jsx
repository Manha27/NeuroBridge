...
const Analytics = () => {
  ...
  const riskData = [
    {
      name: "Low Risk",
      value: patientsData.filter((p) => p.cognitiveRisk === "Low").length,
    },
    {
      name: "Moderate Risk",
      value: patientsData.filter((p) => p.cognitiveRisk === "Moderate").length,
    },
    {
      name: "High Risk",
      value: patientsData.filter((p) => p.cognitiveRisk === "High").length,
    },
  ];
  ...
  const clusterData = [
    {
      ...
      patients: patientsData.filter(
        (p) => p.cluster === "Low Support"
      ).length,
    },
    {
      cluster: "Moderate Support",
      patients: patientsData.filter(
        (p) => p.cluster === "Moderate Support"
      ).length,
    },
    {
      cluster: "High Support",
      patients: patientsData.filter(
        (p) => p.cluster === "High Support"
      ).length,
    },
  ];
  ...
  return (
    <div className="p-6 bg-slate-950 min-h-screen text-white space-y-8">
      <h1 className="text-4xl font-bold">
        AI Dementia Intelligence Dashboard
      </h1>
      ...
      <div className="grid md:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900 p-5 rounded-2xl">
          <h3 className="text-gray-400">High Risk Patients</h3>
          <p className="text-3xl font-bold mt-2 text-red-400">
            {
              patientsData.filter(
                (p) => p.cognitiveRisk === "High"
              ).length
            }
          </p>
        </div>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl">
          <h3 className="text-gray-400">Average MMSE</h3>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl">
          <h3 className="text-gray-400">Critical Alerts</h3>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900 p-5 rounded-2xl">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Shows overall dementia severity across all patients.
          </p>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Cognitive scores decline significantly with increasing age.
          </p>

          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={ageMMSEData}>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900 p-5 rounded-2xl">
          <h2 className="text-xl font-semibold mb-2">
            Patient Care Clustering
          </h2>

          <p className="text-sm text-gray-400 mb-4">
            AI-based grouping of patients according to support intensity.
          </p>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Tracks MMSE decline over time for high-risk patients.
          </p>
      ...
      <div className="bg-slate-900 p-6 rounded-2xl">
        ...
        <div className="space-y-3 text-gray-300">
          <p>
            • Patients aged 80+ show significantly lower MMSE scores and
            belong mostly to High Support clusters.
          </p>

          <p>
            • Lower education levels are associated with increased
            cognitive decline risk.
          </p>

          <p>
            • High-risk patients require daily monitoring and caregiver
            intervention.
          </p>

          <p>
            • Moderate-support patients benefit from weekly cognitive
            assessment and memory exercises.
          </p>
        </div>
      </div>
    </div>
